/*Original AI credit goes to https://github.com/Mostafa-Samir/Tic-Tac-Toe-AI
The following code borrows heavily, but has been expanded in order to give the
AI more flexibility in levels of competence and to allow for no AI player. */
...
var AI = function(level) {
    ...
    function takeABlindMove(turn) {
        ...
        console.log("AI wanted to go Here: " + randomCell);
    ...
    function takeMove(turn) {
        console.log("TakeMove was triggered.");
        var available = game.currentState.emptyCells();
        ...
        /*
         * Edits made here. Initially this was locked to only have one factor of probability.
         * Now the AI's levelOfIntelligence is dictated by a percentage of 10% - 90%
         * The AI will never be 100% certain of optimal performance, but can vary its play
         * more.
         */
        var chosenAction;
        if(Math.random()*100 < selectedDifficulty) {
        ...
        console.log("AI wanted to go here: " + chosenAction.movePosition);
    ...
    this.notify = function(turn) {
      console.log("AI Notified of turn.");
      if(selectedDifficulty<10? takeABlindMove(turn) : takeMove(turn));
    };
};
